    ...
    <div className="mx-8 mt-5">
      ...
      <div className="w-full max-w-3xl mt-5">
        ...
        <div className="bg-gray-200 border-gray-300 lg:mx-18 rounded-2xl text-sm max-h-[80vh] min-h-[50vh] overflow-y-scroll p-3">
          ...
          <div className=" bg-white rounded-xl mx-2 flex flex-wrap text-center justify-between mb-2 max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[1fr_3fr_2fr] gap-1 items-center text-gray-900 py-3 px-6 border">
            <p>Test</p>
            <p>Test@gmail.com</p>
            <p>+91 1234567890</p>
          </div>

          <div className=" bg-white rounded-xl mx-2 flex flex-wrap text-center justify-between max-sm:gap-5 max-sm:text-base sm:grid grid-cols-[1fr_3fr_2fr] gap-1 items-center text-gray-900 py-3 px-6 border">
            <p>Example</p>
